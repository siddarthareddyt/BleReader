package com.mcc.ul.example.ainscan;
...
import com.mcc.ul.example.ainscan.NetDiscoveryInfoDialog;
import com.mcc.ul.example.ainscan.NetDiscoveryInfoDialog.NoticeDialogListener;
import com.mcc.ul.example.ainscan.R;
...
public class AInScanActivity extends Activity {
    ...
    void addScanDataTextViews(int chanCount) {
    	...
    	mScanChansTextView[chanCount - 1].setPadding(0, 0, 0, 50);
